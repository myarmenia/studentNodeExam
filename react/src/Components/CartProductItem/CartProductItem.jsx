...
const CartProductItem = ({ wine }) => {
  ...
  const decreaseCount = async () => {
    ...
    if (newCount < 1) {
      const { payload } = await dispatch(
        deleteCartItem({ cartItemId: wine._id })
      );
      dispatch(getCartThunk());
      dispatch(changeCartItemCount());
    } else {
    ...
    <div className="cart_product_item">
      ...
      <div className="product_edit" onClick={removeCartItem}>
        ...
        >
          ...
          />
          <path
            d="M28.125 7.875V29.25C28.125 29.5484 28.0065 29.8345 27.7955 30.0455C27.5845 30.2565 27.2984 30.375 27 30.375H9C8.70163 30.375 8.41548 30.2565 8.20451 30.0455C7.99353 29.8345 7.875 29.5484 7.875 29.25V7.875"
            stroke="black"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M23.625 7.875V5.625C23.625 5.02826 23.3879 4.45597 22.966 4.03401C22.544 3.61205 21.9717 3.375 21.375 3.375H14.625C14.0283 3.375 13.456 3.61205 13.034 4.03401C12.6121 4.45597 12.375 5.02826 12.375 5.625V7.875"
            stroke="black"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
