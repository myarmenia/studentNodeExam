...
import { cartCheckout, getCartThunk } from '../../../Redux/Slices/Cart/cartThunks'
...
const handleCheckout = async ()=>{
  ...
  return (
        ...
        <div className="ceckout_payment">
            ...
            {
                message.length ? <div className={message.toLowerCase().includes("were bought")?"back_ok": "back_err"}>{message}</div> :""
            }
        </div>
