  ...
  return (
    <div className='search_div'>
        <div className="inp_div">
            <input value={searchValue} onChange={(e)=>dispatch(setSearchValue(e.target.value))}/>

            </div>
            <div className="products" style={{display: searchValue.length? "flex":"none"}}>
            {
                searchValue.length? wines.map((el)=> {
